...
const EmptyYourPostsState = memo(function EmptyYourPostsState() {
  ...
  return <section className="your-posts__empty">
    <svg className="your-posts__empty-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 4.75A1.75 1.75 0 0 1 6.75 3h10.5A1.75 1.75 0 0 1 19 4.75v14.5A1.75 1.75 0 0 1 17.25 21H6.75A1.75 1.75 0 0 1 5 19.25V4.75Z" /><path d="M8 8h8M8 12h8M8 16h5" /></svg>
...
export const YourPostsPage = memo(function YourPostsPage() {
  ...
  const posts = useSelector((state: RootState) => state.posts?.posts?.filter((post) => post.authorId === user?.id) ?? [])

  return <div className="dashboard your-posts"><DashboardNavbar /><main className="dashboard__content">
    <header className="your-posts__header">
