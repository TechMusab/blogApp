...
const EmptyYourPostsState = memo(function EmptyYourPostsState() {
  ...
  return (
    <section className="your-posts__empty">
      <svg className="your-posts__empty-icon" viewBox="0 0 24 24" aria-hidden="true">
...
export const YourPostsPage = memo(function YourPostsPage() {
  ...
  const posts = useSelector(
    (state: RootState) => state.posts?.posts?.filter((post) => post.authorId === user?.id) ?? []
  );

  return (
    <div className="dashboard your-posts">
      <DashboardNavbar />
