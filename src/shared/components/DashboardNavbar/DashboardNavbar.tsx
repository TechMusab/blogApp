    ...
    <div className="dashboard__navbar-right">
      ...
      <div className="dashboard__profile-menu">
        ...
        <Dropdown open={menuOpen} onClose={closeMenu}
          ...
          items={[{ label: 'Account settings', icon: '⚙', onClick: closeMenu }, { label: 'Saved posts', icon: '▱', onClick: () => { closeMenu(); navigate('/saved-posts') } }, { label: 'Write a post', icon: '⌕', onClick: goToCreate }]}
